...
library(readxl)
library(tidyverse)
landings <- read_excel("~/Desktop/landings_excel.xlsx")
view(landings)
```
...
theil_2007 <- landings %>%
  filter(sp_name == "COD, ATLANTIC", year == 2007, value > 2000) 

total_2007 = sum(theil_2007$value)

theil_2007 <- theil_2007 %>%
  group_by(port_state) %>%
  mutate(perc_landings = value / total_2007)

theil(theil_2007$value)


theil_2019 <- landings %>%
  filter(sp_name == "COD, ATLANTIC", year == 2019) 

total_2019 = sum(theil_2019$value)

theil_2019 <- theil_2019 %>%
  group_by(port_state) %>%
  mutate(perc_landings = value / total_2019)

theil(theil_2019$value, weighting = theil_2019$perc_landings)
